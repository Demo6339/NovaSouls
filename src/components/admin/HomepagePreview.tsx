  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-8 bg-gray-50">
        <div className="text-center mb-8">
          <Badge className="mb-4 bg-accent/10 text-accent">
            {settings.testimonials_badge_text || "Đánh giá khách hàng"}
          </Badge>
          <h2 className={`${settings.section_title_size || 'text-4xl'} font-bold mb-4`}>
            {settings.testimonials_title || "Khách hàng nói gì về chúng tôi"}
          </h2>
          <p className="text-gray-600">
            {settings.testimonials_subtitle || "Những phản hồi chân thực từ khách hàng..."}
          </p>
        </div>
        
        <div className={`grid grid-cols-${settings.testimonials_columns || '3'} gap-6 mb-8`}>
          {[1, 2, 3].map((i) => (
            <Card key={i} className="p-6">
              ...
              <p className="text-gray-600 mb-4 italic">
                "Đánh giá khách hàng {i} - Cà phê rất ngon, không gian đẹp..."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gray-300 rounded-full"></div>
                <div>
                  <h4 className="font-semibold">Khách hàng {i}</h4>
          ...
          <div className="grid grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-2xl font-bold text-accent mb-2">
                {settings.testimonials_stats_rating || "4.9/5"}
              </div>
              <div className="text-sm text-gray-600">Đánh giá trung bình</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-accent mb-2">
                {settings.testimonials_stats_customers || "2,500+"}
              </div>
              <div className="text-sm text-gray-600">Khách hàng hài lòng</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-accent mb-2">
                {settings.testimonials_stats_return || "98%"}
              </div>
