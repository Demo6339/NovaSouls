        ...
        <div className="container px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            ...
            <div className="flex-1">
              ...
              {/* Products Grid/List */}
              {isLoading ? (
                <div className={viewMode === "grid" ? "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3" : "space-y-2"}>
                ...
                <div className={viewMode === "grid" ? "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3" : "space-y-2"}>
                  {paginatedItems.map((item, index) => (
                    ...
                    >
                      <div className={`relative overflow-hidden ${viewMode === "list" ? "w-20 sm:w-24 h-20 sm:h-24" : "h-24 sm:h-32"}`}>
                        <img
                          src={item.image}
                          alt={item.name}
                        ...
                        {/* Action Buttons */}
                        <div className="action-buttons absolute top-1 right-1 flex flex-col gap-0.5">
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-5 w-5 p-0 bg-white/90 hover:bg-white shadow-md"
                            onClick={(e) => {
                              e.stopPropagation();
                      ...
                      <div className={`p-2 ${viewMode === "list" ? "flex-1" : ""}`}>
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Button 
                              size="sm"
                              className="bg-accent hover:bg-accent/90 text-accent-foreground h-6 px-2 text-xs"
                              onClick={(e) => {
                                e.stopPropagation();
